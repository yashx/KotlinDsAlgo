 ...
 * case. Once the subproblems become small enough that we no longer recurse,
 * we say that the recursion “bottoms out” and that we have gotten down to the base case.
 *
